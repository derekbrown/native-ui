...
function IconButton({ className = "", disabled = false, icon, type = "default", key = "", onClick }) {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("button", { key, disabled, className: `${baseClasses} ${typeClasses} ${className}`, onClick }, icon);
}
...
function SecondaryButton({ caption = "Secondary", className = "", disabled = false, icon, type = "default", key = "", onClick }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("button", { key, disabled, className: `${baseClasses} ${typeClasses} ${className}`, onClick }, caption, icon);
}
...
function DisplayPill({ caption = "DisplayPill", className = "", icon, key = "" }) {
  ...
  return /* @__PURE__ */ import_react5.default.createElement("div", { key, className: `${baseClasses} ${className}` }, icon, /* @__PURE__ */ import_react5.default.createElement("span", { className: "font-medium" }, caption));
}
